# base_types.jl - Core types and enums for the solver strategy system
...
@enum StiffnessLevel begin
    NON_STIFF      # stiffness_ratio < 10
    MILDLY_STIFF   # 10 ≤ stiffness_ratio < 100  
    STIFF          # 100 ≤ stiffness_ratio < 1000
    VERY_STIFF     # 1000 ≤ stiffness_ratio < 10000
    EXTREMELY_STIFF # stiffness_ratio ≥ 10000
end

@enum SystemSize begin
    SMALL_SYSTEM   # system_size < 100
    MEDIUM_SYSTEM  # 100 ≤ system_size < 1000
    LARGE_SYSTEM   # system_size ≥ 1000
end
...
struct AlgorithmRecommendation{Alg}
    ...
    function AlgorithmRecommendation(alg::Alg, priority::Float64, category::SolverCategory;
                                   ...
                                   stiffness_range::Tuple{StiffnessLevel, StiffnessLevel}=(NON_STIFF, EXTREMELY_STIFF),
                                   system_size_range::Tuple{SystemSize, SystemSize}=(SMALL_SYSTEM, LARGE_SYSTEM),
...
export AlgorithmRecommendation, SolverCategory, StiffnessLevel, SystemSize, AccuracyLevel,
       classify_stiffness, classify_system_size, classify_accuracy_level,
       has_multiscale_behavior, is_well_conditioned, requires_sparse_handling,
